...
export const wal: DeepPartial<Dictionary> = {
  ...
  common: {
    ...
    formError: 'We could not send your message. Please check your connection and try again, or call us.',
  ...
  photoCaptions: {
    ...
    food: { title: 'The Taste of Wolaita', desc: 'Traditional Wolaita dishes, from enset to beans and greens, served in woven baskets inside a cultural house.' },
  ...
  home: {
    ...
    culturalFood: {
      eyebrow: 'Twice every month',
      title: 'The Cultural Food Event',
      desc: 'Twice a month Bushaashe Garuwa opens its cultural houses for an evening of traditional Wolaita food, coffee, music and storytelling. Reserve your place and join us.',
      partner: 'Together with {partner}',
      nextTitle: 'Next dates',
      bookCta: 'Reserve your place',
      allCta: 'See all events',
      soon: 'The next dates will be announced here soon.',
    },
    facilities: {
  ...
  about: {
    ...
    who: {
      ...
      p1: 'Bushaashe Garuwa is a living Wolaita heritage destination in Damot Sore Woreda, Wolaita Zone, Ethiopia: a beautifully developed eco-tourism site, cultivated and cared for by the Bushaashe family. We are more than a museum, a resort, or a tourist attraction; we are a family heritage that has been tended and passed down across four generations.',
      name: 'The name Bushaashe (sometimes written Bushashe) is a family name, and today it is also known across Wolaita as the name of a cultural landmark.',
      ...
      festival: 'Bushaashe Garuwa is also a gathering place for the region: it hosts cultural celebrations, including the eve of Gifaataa, the traditional New Year festival of the Wolaita people.',
      generations: 'Generations',
  ...
  events: {
      booking: {
        ...
        messagePlaceholder: 'Dietary needs, a celebration, arrival time…',
        submit: 'Reserve my place',
        sending: 'Sending…',
        cancel: 'Cancel',
        close: 'Close',
        thanksTitle: 'Your place is reserved',
        thanksText: 'We have received your booking and will call you to confirm the details.',
        referenceLabel: 'Your booking number',
        referenceNote: 'Please keep it. Tell us this number when you call or when you arrive.',
        placesLeft: 'Only {count} places left for this evening.',
        onePlaceLeft: 'Only one place left for this evening.',
        noPlaces: 'This evening is fully booked.',
      },
      live: {
        bookCta: 'Reserve your place',
        partnerWith: 'Together with {partner}',
        limited: 'Limited places',
        full: 'Fully booked',
        open: 'Places available',
        upcomingTitle: 'Coming up at Bushaashe Garuwa',
        placesLeft: '{count} places left',
        onePlaceLeft: 'One place left',
      },
