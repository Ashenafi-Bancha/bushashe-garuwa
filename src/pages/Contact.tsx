    ...
    <main className="pt-20">
      ...
      <section className="bg-[#173F35] py-12 sm:py-16 lg:py-24">
        <div className="max-w-screen-xl mx-auto px-4 sm:px-6">
          <div className="text-[#C99A45] text-xs font-sans font-semibold tracking-[0.3em] uppercase mb-4">{c.hero.eyebrow}</div>
          <h1 className="font-serif text-3xl sm:text-5xl lg:text-6xl font-light text-white leading-tight max-w-xl">{c.hero.title}</h1>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-8">
                <div className="flex items-start gap-5">
                  <div className="w-10 h-10 border border-[#C99A45]/30 flex items-center justify-center flex-shrink-0">
              ...
              <div className="mt-10 pt-10 border-t border-[#173F35]/10">
                ...
                <div className="flex gap-3">
                  {['Facebook', 'Instagram', 'YouTube'].map((s) => (
                    <a key={s} href="#" className="border border-[#173F35]/20 hover:border-[#C99A45] text-[#173F35]/60 hover:text-[#C99A45] text-xs font-sans uppercase tracking-wider px-4 py-2 transition-colors">
                      {s}
                    </a>
                  ))}
                </div>
            ...
            <div className="bg-white p-8 shadow-sm">
              {submitted ? (
                <div className="text-center py-16">
                  ...
                  <h3 className="font-serif text-2xl font-light text-[#173F35] mb-3">{c.form.sentTitle}</h3>
                  <p className="text-[#1D211E]/60 font-sans text-sm leading-relaxed">{c.form.sentText}</p>
                </div>
              ) : (
                <>
                  <h2 className="font-serif text-2xl font-light text-[#173F35] mb-7">{c.form.title}</h2>
                  <form onSubmit={handleSubmit} className="space-y-5">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full border border-[#173F35]/20 focus:border-[#173F35] px-4 py-3 font-sans text-sm text-[#1D211E] outline-none transition-colors bg-[#F6F1E7]"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full border border-[#173F35]/20 focus:border-[#173F35] px-4 py-3 font-sans text-sm text-[#1D211E] outline-none transition-colors bg-[#F6F1E7] resize-none"
