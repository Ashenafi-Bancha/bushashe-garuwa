          ...
          <div className="col-span-2 sm:col-span-2 md:col-span-3 lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <img
                ...
                className="w-16 h-16 object-contain flex-shrink-0 drop-shadow-md"
              />
              <div>
                <div className="text-[#C99A45] font-serif text-base font-semibold tracking-[0.15em] uppercase leading-none">Bushaashe</div>
                <div className="text-white/40 font-sans text-[9px] tracking-[0.2em] uppercase leading-none mt-0.5">Garuwa Lodge</div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap gap-2.5">
              ...
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer"
                className="group flex items-center gap-2 px-3 py-2 rounded-sm bg-white/5 hover:bg-[#1877F2]/20 border border-white/10 hover:border-[#1877F2]/50 transition-all duration-300"
                aria-label="Facebook">
              ...
              <a href="https://tiktok.com" target="_blank" rel="noopener noreferrer"
                className="group flex items-center gap-2 px-3 py-2 rounded-sm bg-white/5 hover:bg-white/10 border border-white/10 hover:border-white/30 transition-all duration-300"
                aria-label="TikTok">
              ...
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer"
                className="group flex items-center gap-2 px-3 py-2 rounded-sm bg-white/5 hover:bg-[#E1306C]/15 border border-white/10 hover:border-[#E1306C]/40 transition-all duration-300"
              ...
              <a href="mailto:info@bushaashegaruwa.com"
                className="group flex items-center gap-2 px-3 py-2 rounded-sm bg-white/5 hover:bg-[#EA4335]/15 border border-white/10 hover:border-[#EA4335]/40 transition-all duration-300"
              ...
              <a href="tel:+251000000000"
                className="group flex items-center gap-2 px-3 py-2 rounded-sm bg-white/5 hover:bg-[#25D366]/15 border border-white/10 hover:border-[#25D366]/40 transition-all duration-300"
